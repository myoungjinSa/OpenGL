...
public:
	...
	void AddGrid(int xStart, int zStart, int width, int length, const Vec3f& positionOffset, const Vec3f& scale, const RGBA& color, const TerrainHeightImage* pHeightImage = NULL);
	...
	void AddQuad(const Vec3f& bottomLeft, const Vec3f& upLeft, float upLength, const Vec3f& bottomRight, float rightLength, const Vec3f& normal, const RGBA& color = RGBA::WHITE, const Vec2f& uvOffset = Vec2f::ZERO, float uvStepSize = 1.0f);
